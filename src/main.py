...
# Function to print the splash screen (Giant ASCII art that says "GOTW", can be changed in the splash.txt file)
...
async def main():
    print_splash()  # I wasted an hour making GOTW ASCII art, but it was too fun to leave out

    log_info('Starting Grammar of the Week service...')

    # Run GOTW loop in the background without blocking main execution
    asyncio.create_task(gotw.gotw_main_loop())
    log_info('GOTW main loop started in background')
